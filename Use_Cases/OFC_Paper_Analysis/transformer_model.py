...
class TransformerEqualizerNet(nn.Module):
    """Transformer network for signal equalization."""
    
    def __init__(self, input_size, d_model=64, nhead=4, num_layers=2, dim_feedforward=256, 
        ...
        """
        super(TransformerEqualizerNet, self).__init__()
...
class TransformerEqualizer:
    """
    Transformer-based equalizer for complex signal equalization.
    """
    
    def __init__(self, num_taps=9, d_model=64, nhead=4, num_layers=2, dim_feedforward=256,
                 dropout=0.1, learning_rate=0.001, batch_size=128, num_epochs=50, random_state=42):
        """
        Initialize Transformer Equalizer.
        ...
        self.model = TransformerEqualizerNet(
    ...
    def train(self, received_symbols, total_tx_symbols, tx_bits, modulation_order, test_size=0.3, verbose=True):
        ...
        if verbose:
            ...
            print("Creating sliding window data for Transformer...")
        ...
        # Convert to PyTorch tensors and reshape for Transformer (add sequence dimension)
