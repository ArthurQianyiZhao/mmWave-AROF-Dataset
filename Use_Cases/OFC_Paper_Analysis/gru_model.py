...
class GRUEqualizerNet(nn.Module):
    """GRU network for signal equalization."""
    ...
    def __init__(self, input_size, hidden_size=64, num_layers=2, output_size=2, dropout=0.2):
        ...
        """
        super(GRUEqualizerNet, self).__init__()
...
class GRUEqualizer:
    """
    GRU-based equalizer for complex signal equalization.
    """
    ...
    def train(self, received_symbols, total_tx_symbols, tx_bits, modulation_order, test_size=0.3, verbose=True):
        ...
        if verbose:
            ...
            print("Creating sliding window data for GRU...")
        ...
        # Convert to PyTorch tensors and reshape for GRU (add sequence dimension)
